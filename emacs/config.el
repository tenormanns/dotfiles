...
(after! org
  (setq org-agenda-files
        (append (directory-files-recursively "~/org/" "\\.org$")
                (directory-files-recursively "~/org/org-roam/" "\\.org$"))))

;; ==============================
;; Org-roam & Org Capture Config
;; ==============================
...
(after! org-roam
  ...
  (defun my/org-capture-note-dispatch ()
    ...
    (let* ((note-type (completing-read "Note type: " '("Generic" "University" "Book" "Personal") nil t))
      ...
      (org-roam-capture- :node node :keys template-key)))

  ;; ===========================
  ;; Daily Plan (Truly Date-Aware)
  ;; ===========================
